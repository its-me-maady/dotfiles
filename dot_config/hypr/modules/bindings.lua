...
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "V", hl.dsp.exec_cmd("pkill rofi || rofi -modi clipboard:~/.config/cliphist/cliphist-rofi -show clipboard"))
...
-- bind = $mainMod ,P, exec , pkill wshowkeys || wshowkeys

-- Set keybind to change the wallpaper to the next one in the current directory

hl.bind(mainMod .. " + " .. "R", hl.dsp.exec_cmd("wallpaper_changer"))

hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "R", hl.dsp.exec_cmd("wallpaper_selector"))

-- Laptop multimedia keys for volume and LCD brightness

hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 1%+"), { locked = true })
